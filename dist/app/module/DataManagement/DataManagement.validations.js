...
exports.DataManagementValidations = void 0;
const client_1 = require("@prisma/client");
const zod_1 = require("zod");
const addDataManagementRecordValidationSchema = zod_1.z.object({
    body: zod_1.z.object({
        title: zod_1.z
            .string({
        ...
        month_uploaded: zod_1.z.string().optional(),
...
exports.DataManagementValidations = {
    addDataManagementRecordValidationSchema,
};
